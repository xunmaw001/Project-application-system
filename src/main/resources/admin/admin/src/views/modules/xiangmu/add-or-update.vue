    ...
    <div class="addEdit-block">
        <el-form
            ...
            <el-row>
                ...
                <el-col :span="12" v-if="sessionTable !='zhuanjia' ">
                    <el-form-item class="upload" v-if="type!='info' && !ro.zhuanjiaPhoto" label="专家头像" prop="zhuanjiaPhoto">
                        <img style="margin-right:20px;" v-bind:key="index" v-for="(item,index) in (zhuanjiaForm.zhuanjiaPhoto || '').split(',')" :src="$base.url+item" width="100" height="100">
                    </el-form-item>
                    <div v-else-if="type=='info'">
                ...
                <el-col :span="12"  v-if="sessionTable !='zhuanjia' ">
                    <el-form-item class="input" v-if="type!='info'"  label="账户状态" prop="jinyongValue">
                        <el-input v-model="zhuanjiaForm.jinyongValue"
                                  placeholder="账户状态" clearable readonly></el-input>
                    </el-form-item>
                    <div v-else-if="type=='info'">
                        <el-form-item class="input" label="账户状态" prop="jinyongValue">
            ...
            <input id="zhuanjiaId" name="zhuanjiaId" type="hidden">
               ...
               <el-col :span="12">
                   <el-form-item class="input" v-if="type!='info'"  label="项目地点" prop="xiangmuAddress">
                       <el-input v-model="ruleForm.xiangmuAddress"
                                 placeholder="项目地点" clearable  :readonly="ro.xiangmuAddress"></el-input>
                   </el-form-item>
                   <div v-else-if="type=='info'">
                       <el-form-item class="input" label="项目地点" prop="xiangmuAddress">
                           <el-input v-model="ruleForm.xiangmuAddress"
                                     placeholder="项目地点" readonly></el-input>
                       </el-form-item>
                   </div>
               </el-col>
                <el-col :span="12">
                    <el-form-item v-if="type!='info' && !ro.xiangmuKaishiTime"  class="input" label="项目开始时间" prop="xiangmuKaishiTime">
                        <el-date-picker
                                value-format="yyyy-MM-dd HH:mm:ss"
                                v-model="ruleForm.xiangmuKaishiTime"
                                type="datetime"
                                placeholder="项目开始时间"
                                :disabled="ro.xiangmuKaishiTime">
                        </el-date-picker>
                    </el-form-item>
                    <div v-else-if="type=='info'">
                        <el-form-item v-if="ruleForm.xiangmuKaishiTime" label="项目开始时间" prop="xiangmuKaishiTime">
                            <span v-html="ruleForm.xiangmuKaishiTime"></span>
                        </el-form-item>
                    </div>
                </el-col>

                <el-col :span="12">
                    <el-form-item v-if="type!='info' && !ro.xiangmuJieshuTime"  class="input" label="项目结束时间" prop="xiangmuJieshuTime">
                        <el-date-picker
                                value-format="yyyy-MM-dd HH:mm:ss"
                                v-model="ruleForm.xiangmuJieshuTime"
                                type="datetime"
                                placeholder="项目结束时间"
                                :disabled="ro.xiangmuJieshuTime">
                        </el-date-picker>
                    </el-form-item>
                    <div v-else-if="type=='info'">
                        <el-form-item v-if="ruleForm.xiangmuJieshuTime" label="项目结束时间" prop="xiangmuJieshuTime">
                            <span v-html="ruleForm.xiangmuJieshuTime"></span>
                        </el-form-item>
                    </div>
                </el-col>
                ...
                <el-col :span="12">
                    <el-form-item class="select" v-if="type!='info'"  label="项目等级" prop="xiangmuDengjiTypes">
                        <el-select v-model="ruleForm.xiangmuDengjiTypes" :disabled="ro.xiangmuDengjiTypes" placeholder="请选择项目等级">
                            <el-option
                                v-for="(item,index) in xiangmuDengjiTypesOptions"
                                v-bind:key="item.codeIndex"
                                :label="item.indexName"
                                :value="item.codeIndex">
                            </el-option>
                    ...
                    <div v-else-if="type=='info'">
                        <el-form-item class="input" label="项目等级" prop="xiangmuDengjiValue">
                        <el-input v-model="ruleForm.xiangmuDengjiValue"
            ...
            <el-col :span="12" v-if="type=='info'">
                <div>
                    <el-form-item v-if="ruleForm.xiangmuYesnoTypes" label="审核状态" prop="xiangmuYesnoTypes">
                        <el-input v-model="ruleForm.xiangmuYesnoValue" placeholder="审核状态" readonly></el-input>
                    </el-form-item>
                </div>
            </el-col>
            <el-col :span="12" v-if="type=='info'">
    ...
    export default {
        data() {
            return {
                ...
                ro:{
                    ...
                    xiangmuKaishiTime: false,
                    xiangmuJieshuTime: false,
                    xiangmuTypes: false,
                    xiangmuDengjiTypes: false,
        ...
        created() {
            ...
            //获取下拉框信息
                ...
                this.$http({
                    url:`dictionary/page?page=1&limit=100&sort=&order=&dicCode=xiangmu_dengji_types`,
                    method: "get"
                }).then(({ data }) => {
                    if (data && data.code === 0) {
                        this.xiangmuDengjiTypesOptions = data.data.list;
                    }
                });
                this.$http({
