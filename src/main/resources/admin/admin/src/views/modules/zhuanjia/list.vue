                ...
                <el-row class="ad" :style="{justifyContent:contents.btnAdAllBoxPosition=='1'?'flex-start':contents.btnAdAllBoxPosition=='2'?'center':'flex-end'}">
                    <el-form-item>
                        ...
                        <a style="text-decoration:none" class="el-button el-button--success"
                           ...
                           href="http://localhost:8080/xiangmushenbaoxitong/upload/zhuanjiaMuBan.xls"
                        >批量导入专家数据模板</a>
                        &nbsp;
                        <el-upload
                                v-if="isAuth('zhuanjia','导入导出')"
                ...
                <el-table class="tables" :size="contents.tableSize" :show-header="contents.tableShowHeader"
                    ...
                    <el-table-column width="300" :align="contents.tableAlign"
                        ...
                        <template slot-scope="scope">
                            ...
                            <el-button v-if="isAuth('zhuanjia','修改')" type="success" size="mini" @click="jinqiyong(scope.row.id,scope.row.jinyongTypes)">{{scope.row.jinyongTypes == 1?'禁用账户':'启用账户'}}</el-button>
        ...
        methods: {
            ...
            jinqiyong(id,jinyongTypes) {
                ...
                _this.$confirm(msg, "提示", {confirmButtonText: "确定",cancelButtonText: "取消",type: "warning"}).then(() => {
                    _this.$http({url: "zhuanjia/update",method: "post",data: {id:id,jinyongTypes:jinyongTypes,}}).then(({data}) => {
                        if(data && data.code === 0){
