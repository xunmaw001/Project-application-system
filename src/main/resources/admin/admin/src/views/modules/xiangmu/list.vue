        ...
        <el-dialog title="审核" :visible.sync="xiangmuYesnoTypesVisible">
            <el-form :model="form">
                ...
                <el-form-item label="审核" >
                    <el-select v-model="form.xiangmuYesnoTypes" placeholder="请选择审核状态">
        ...
        <div v-if="showFlag">
            <el-form :inline="true" :model="searchForm" class="form-content">
                <el-row :gutter="20" class="slt" :style="{justifyContent:contents.searchBoxPosition=='1'?'flex-start':contents.searchBoxPosition=='2'?'center':'flex-end'}">
                     ...
                     <el-form-item :label="contents.inputTitle == 1 ? '项目等级' : ''">
                        <el-select v-model="searchForm.xiangmuDengjiTypes" placeholder="请选择项目等级">
                            <el-option label="=-请选择-=" value=""></el-option>
                            <el-option
                               v-for="(item,index) in xiangmuDengjiTypesSelectSearch"
                               v-bind:key="index"
                               :label="item.indexName"
                               :value="item.codeIndex">
                            <!--lable是要展示的名称-->
                ...
                <el-row class="ad" :style="{justifyContent:contents.btnAdAllBoxPosition=='1'?'flex-start':contents.btnAdAllBoxPosition=='2'?'center':'flex-end'}">
                    <el-form-item>
                        ...
                        <a style="text-decoration:none" class="el-button el-button--success"
                           ...
                           href="http://localhost:8080/xiangmushenbaoxitong/upload/xiangmuMuBan.xls"
                        >批量导入项目数据模板</a>
                        &nbsp;
                        <el-upload
                                v-if="isAuth('xiangmu','导入导出')"
            ...
            <div class="table-content">
                <el-table class="tables" :size="contents.tableSize" :show-header="contents.tableShowHeader"
                    ...
                    <el-table-column  :sortable="contents.tableSortable" :align="contents.tableAlign"
                                   prop="xiangmuKaishiTime"
                                   header-align="center"
                                   label="项目开始时间">
                        <template slot-scope="scope">
                            {{scope.row.xiangmuKaishiTime}}
                        </template>
                    </el-table-column>

                    <el-table-column  :sortable="contents.tableSortable" :align="contents.tableAlign"
                                   prop="xiangmuJieshuTime"
                                   header-align="center"
                                   label="项目结束时间">
                        <template slot-scope="scope">
                            {{scope.row.xiangmuJieshuTime}}
                        </template>
                    </el-table-column>
                    <el-table-column  :sortable="contents.tableSortable" :align="contents.tableAlign"
                                      prop="xiangmuTypes"
                    ...
                    <el-table-column  :sortable="contents.tableSortable" :align="contents.tableAlign"
                                      prop="xiangmuDengjiTypes"
                                      header-align="center"
                                      label="项目等级">
                        <template slot-scope="scope">
                            {{scope.row.xiangmuDengjiValue}}
                        </template>
                    </el-table-column>
...
<script>
    ...
    //当前表下拉框搜索条件
              ...
              xiangmuDengjiTypesSelectSearch : [],
            ...
            form:{
                ...
                xiangmuPhoto : null,
                xiangmuAddress : null,
                xiangmuKaishiTime : null,
                xiangmuJieshuTime : null,
                xiangmuTypes : null,
                xiangmuDengjiTypes : null,
                xiangmuContent : null,
                insertTime : null,
            ...
            json_fields: {
                ...
                //本表字段
                     ...
                     '项目照片': "xiangmuPhoto",
                     '项目地点': "xiangmuAddress",
                     '项目开始时间': "xiangmuKaishiTime",
                     '项目结束时间': "xiangmuJieshuTime",
                     '项目类型': "xiangmuValue",
                     '项目等级': "xiangmuDengjiValue",
                     '录入时间': "insertTime",
                     '审核状态': "xiangmuYesnoValue",
        ...
        methods: {
            chartDialog() {
                ...
                this.$nextTick(()=>{
                    ...
                    let params = {
                        tableName: "xiangmu",
                        groupColumn: "xiangmu_dengji_types",
            ...
            getDataList() {
                ...
                if (this.searchForm.xiangmuDengjiTypes!= '' && this.searchForm.xiangmuDengjiTypes!= undefined) {
                    params['xiangmuDengjiTypes'] = this.searchForm.xiangmuDengjiTypes
                }
                ...
                //填充下拉框选项
                this.$http({
                    url: "dictionary/page?dicCode=xiangmu_dengji_types&page=1&limit=100",
                    method: "get",
                }).then(({data}) => {
                    if(data && data.code === 0){
                        this.xiangmuDengjiTypesSelectSearch = data.data.list;
                    }
                });
                //填充下拉框选项
                this.$http({
            ...
            openYesnoTypes(id) {
                ...
                _this.form.xiangmuYesnoTypes = "请选择审核状态";
                _this.xiangmuYesnoTypesVisible = true;
            },

            xiangmuYesnoTypesShenhe() {
                let _this = this;
                if(_this.form.xiangmuYesnoTypes == "请选择审核状态"){
